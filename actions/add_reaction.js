...
fields: ["storage", "varName", "emoji", "varName2"],
...
action: function(cache) {
	...
	let emoji;
	if(type === 0) {
		emoji = cache.server.emojis.find('name', varName2);
	} else {
		emoji = this.getVariable(type, varName2, cache);
	}

	if(emoji && message && message.react) {
